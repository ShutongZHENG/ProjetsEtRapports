...
void addition(int *A, int *B, int *C, int N, int rows)
{
...
int main(int argc, char *argv[])
{
    ...
    AL = (int *)malloc(NL * N * sizeof(int));   // 初始化 AL
    BL = (int *)malloc(NL * N * sizeof(int));   // 初始化 BL
    TEMP = (int *)malloc(NL * N * sizeof(int));   // 初始化 TEMP
